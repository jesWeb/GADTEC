                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3">
                            ...
                            <div>
                                ...
                                <input type="text" name="num_empleado" id="num_empleado"
                                    value="{{ old('num_empleado') }}" placeholder="AA-BB-CC-DDDD-E"
                            ...
                            <!-- Apellido Paterno -->
                            <div>
                                <label for="app" class="block text-base font-medium text-gray-700">Apellido
                                    Paterno</label>
                            ...
                            <!-- Apellido Materno -->
                            <div>
                                <label for="apm" class="block text-base font-medium text-gray-700">Apellido
                                    Materno</label>
                            ...
                            <!-- Licencia -->
                            <div>
                                <label for="num_licencia"
                                    class="block text-base font-medium text-gray-700">Licencia</label>
                                <input type="num_licencia" name="num_licencia" id="num_licencia"
                                    value="{{ old('num_licencia') }}" placeholder="Ejemplo: 987654325"
                                    class="w-full px-4 py-2 mt-2 text-base border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                                    title="Ingresa el numero de licencia">
                                @error('licencia')
                                    <span class="text-sm text-red-600">{{ $message }}</span>
                                @enderror
                            </div>
