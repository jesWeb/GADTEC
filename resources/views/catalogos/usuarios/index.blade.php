...
<div class="px-4 py-6">
    <div class="p-6 bg-white rounded-md shadow-md">
        ...
        <div class="mb-2">
            <form action="{{ route('usuarios.index') }}" method="GET" class="flex flex-col items-center justify-between space-y-2 md:flex-row md:space-y-0">
                <!-- Campo de búsqueda -->
            ...
            <div class="flex justify-end ml-2 space-x-2">
                <a href="{{route("usuarios-pdf")}}" target="_blank" teal class="inline-block px-4 py-2 text-white bg-green-600 rounded hover:bg-green-700">Imprimir</a>
