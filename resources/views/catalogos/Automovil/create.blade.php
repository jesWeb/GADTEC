    ...
    <div class="p-6 bg-white rounded-md shadow-md">
        ...
        <form action="{{ route('Automovil.store') }}" enctype="multipart/form-data" method="POST">
            ...
            <div class="flex justify-end gap-4 mt-4">
                ...
                <button type="submit" class="px-4 py-2 text-white bg-indigo-600 rounded-md shadow-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500">Registrar</button>
            </div>
        </form>
    </div>
</div>
