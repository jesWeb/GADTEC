                        ...
                        <div class="w-full px-3 xl:w-1/2">
                            <div class="xl:mb-5">
                                ...
                                <select name="combustible"
                                    ...
                                    <option {{ old($auto->combustible) == 'gasolina' ? 'selected' : '' }}value="Gasolina">
                                        Gasolina
                                    </option>
                                    <option {{ old($auto->combustible) == 'diesel' ? 'selected' : '' }} value="Diesel">
                                        Diesel</option>
                                    <option {{ old($auto->combustible) == 'electrico' ? 'selected' : '' }}
                                        value="Electrico">Electrico
                                    </option>
                                </select>
                            </div>
                        ...
                        <div class="w-full px-3 xl:w-1/4">
                            <div class="xl:mb-5">
                                ...
                                <select name="uso"
                                    ...
                                    required>
                                    <option disabled selected>Selecciona una opción </option>
                                    <option {{ old($auto->uso) == 'ninguno' ? 'seleccted' : '' }} value="ninguno">ninguno
                                    </option>
                                    <option {{ old($auto->uso) == 'comisiones' ? 'seleccted' : '' }} value="comisiones ">
                                        Comisiones
                                    </option>
                                    <option {{ old($auto->uso) == 'transporte' ? 'seleccted' : '' }} value="transporte">
                                        transporte
                                    </option>
                                </select>
                            </div>
