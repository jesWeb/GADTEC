...
<div class="px-4 py-6">
    <div class="p-6 bg-white rounded-md shadow-md">
        ...
        <div class="mb-2">
            <form action="{{ route('Automovil.index') }}" method="GET" class="flex flex-col items-center justify-between space-y-2 md:flex-row md:space-y-0">
            ...
            <div class="flex justify-end ml-2 space-x-2">
                <a href="{{ route('automoviles-pdf') }}" target="_blank" class="inline-block px-4 py-2 text-white bg-green-600 rounded hover:bg-green-700">Imprimir</a>
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-2 border">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <form action="{{ route('Automovil.destroy', $car) }}" method="POST" id="eliminacion-form" class="inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" onclick="deleteRegister(event)" class="inline-flex items-center justify-center w-8 h-8 text-red-600 border border-red-600 rounded hover:bg-red-600 hover:text-white">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="w-4 h-4">
