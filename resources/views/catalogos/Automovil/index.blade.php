    ...
    <div class="px-4 py-6">
        <div class="p-6 bg-white rounded-md shadow-md">
            ...
            <div class="mb-4 text-right">
                {{-- <a href="{{route("automoviles-pdf")}}" target="_blank" teal class="inline-block px-4 py-2 text-white bg-green-600 rounded hover:bg-green-700">Imprimir</a> --}}
