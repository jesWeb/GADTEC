    ...
    <div class="flex flex-col gap-9">
        <div class="p-6 bg-white border rounded-md shadow-md">
            ...
            <form action="{{ route('siniestros.update', $EddSin->id_siniestro) }} " method="POST">
                ...
                <div class="m-3 xl:p-10">
                        ...
                        <div class="w-full px-3 xl:w-1/2">
                            ...
                            <select name="id_automovil" id="id_automovil"
                                ...
                                @foreach ($automoviles as $automovil)
                                    <option  disavalue="{{ $automovil->id_automovil }}" {{ ($EddSin->id_automovil) == $automovil->id_automovil ? 'selected' : '' }}>
                    ...
                    <div class="flex flex-col gap-5.5 xl:flex-row">
                        ...
                        <div class="w-full px-3 xl:w-1/2">
                            ...
                            <select name="estatus"
                                class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                                required>
                                <option disabled {{ old('estatus') ? '' : 'selected' }}>Selecciona una opción</option>
                        ...
                        <div class="w-full px-3 xl:w-1/2">
                            ...
                            <input
                                ...
                                value="{{ $EddSin->costo_danos_estimados }}" required>
                        </div>
                    </div>
                    ...
                    <div class="mt-5">
                        ...
                        <textarea
                            class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                            name="observaciones" placeholder="Observaciones..." required>{{ old('observaciones') }}</textarea>
                    </div>
            ...
            <div class="flex justify-end mt-6 space-x-4">
                <a href="{{ route('siniestros.index') }}" class="px-4 py-2 text-gray-700 bg-gray-200 rounded-md shadow-md hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-300">Cancelar</a>
