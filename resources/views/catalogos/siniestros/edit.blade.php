            ...
            <div class="m-3 xl:p-10">
                ...
                <div class="flex flex-col gap-5.5 xl:flex-row">
                    ...
                    <div class="w-full px-3 xl:w-1/2">
                        ...
                        <select name="id_usuario"
                            class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                            required
                            title="Actualizar responsable del siniestro">
                ...
                <div class="flex flex-col gap-5.5 mt-5 xl:flex-row">
                    ...
                    <div class="w-full px-3 xl:w-1/2">
                        ...
                        <select name="estatus"
                            class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                            required
                            title="Actualizar el estatus del siniestro">
                    ...
                    <div class="w-full px-3 xl:w-1/2">
                        ...
                        <input
                            ...
                            title="Actualizar el costo de los daños estimados">
                ...
                <div class="flex flex-col mt-5 gap-5.5 xl:flex-row">
                    <div class="w-full px-3 xl:w-1/2">
                        ...
                        <textarea
                            ...
                            title="Actualizar la descripción del siniestro">{{ $EddSin->descripcion }}</textarea>
                    </div>
                </div>
                ...
                <div class="mt-5">
                    ...
                    <textarea
                        ...
                        title="Actualizar observaciones adicionales">{{ old('observaciones') }}</textarea>
                </div>
            </div>
