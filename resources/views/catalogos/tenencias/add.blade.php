...
<div class="mt-8">
    <div class="mt-4">
        <div class="p-6 bg-white rounded-lg shadow-lg">
            ...
            <form action="{{ url('tenencias') }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="flex justify-end mt-6 space-x-4">
                    ...
                    <a href="{{ url('tenencias') }}" class="px-4 py-2 text-gray-700 bg-gray-200 rounded-md shadow-md hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-300">Cancelar</a>
                </div>
            </form>
        </div>
    </div>
