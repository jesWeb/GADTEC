                        ...
                        <div class="mt-6 ml-4 space-y-6">
                            <div class="grid grid-cols-2 gap-6 md:grid-cols-3">
                                ...
                                <div class="p-4 bg-white rounded-lg shadow-sm">
                                    ...
                                    <span class="mt-2 text-base leading-relaxed text-gray-500 ">
                                        {{ date('d-m-Y', strtotime($asignacionV->fecha_salida)) }}
                                    </span>
                                </div>
                                <div class="p-4 bg-white rounded-lg shadow-sm">
                                    <h4 class="text-lg font-semibold text-gray-800">Hora de salida:</h4>
                                    <span class="mt-2 text-base leading-relaxed text-gray-500 ">
                                        {{ date('h : i a', strtotime($asignacionV->hora_salida)) }}
                                    </span>
                                </div>
                                <div class="p-4 bg-white rounded-lg shadow-sm">
                                    <h4 class="text-lg font-semibold text-gray-800">Lugar de Destino:</h4>
                                    <span
                                        class="mt-2 text-base leading-relaxed text-gray-500 ">{{ $asignacionV->lugar }}</span>
                                </div>
                                <div class="p-4 bg-white rounded-lg shadow-sm">
                                    <h4 class="text-lg font-semibold text-gray-800">Motivo:</h4>
                                    <span
                                        class="mt-2 text-base leading-relaxed text-gray-500 ">{{ $asignacionV->motivo }}</span>
                                </div>

                                <div class="p-4 bg-white rounded-lg shadow-sm">
                                    <h4 class="text-lg font-semibold text-gray-800">No.Licencia:</h4>
                                    <span
                                        class="mt-2 text-base leading-relaxed text-gray-500 ">{{ $asignacionV->no_licencia }}</span>
                                </div>
                                @if ($asignacionV->requierechofer == 1)
                                    <div class="p-4 bg-white rounded-lg shadow-sm">
                                        <h4 class="text-lg font-semibold text-gray-800">Requiere conductor:</h4>
                                        <span class="mt-2 text-base leading-relaxed text-gray-500 ">
                                            @if ($asignacionV->requierechofer == 1)
                                                si
                                            @endif
                                ...
                                <div class="p-4 bg-white rounded-lg shadow-sm">
                                    ...
                                    <span class="mt-2 text-base leading-relaxed text-gray-500 ">
                                        @if ($asignacionV->condiciones)
                                            {{ $asignacionV->condiciones }}
                                        @else
                                            N/A
                                        @endif
                                    </span>
