    ...
    <div class="px-4 py-6">
        <div class="p-6 bg-white rounded-md shadow-md">
            ...
            <div class="mb-4 text-right">
                <a href="{{ route('asignacion.create') }}"class="inline-block px-4 py-2 text-white bg-blue-600 rounded hover:bg-blue-700">Nueva Solicitud</a>
            </div>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-2 border">
                                    <div class="flex justify-center space-x-2">
                                        ...
                                        <!-- Editar -->
                                        <a href="{{ route('asignacion.edit', $reserv->id_asignacion) }}" class="inline-flex items-center justify-center w-8 h-8 text-yellow-600 border border-yellow-600 rounded hover:bg-yellow-600 hover:text-white">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="w-4 h-4">
