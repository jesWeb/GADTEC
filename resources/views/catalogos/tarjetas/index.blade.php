            ...
            <table class="min-w-full bg-white border border-gray-200 divide-y divide-gray-200">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-2 border">
                            {{ \Carbon\Carbon::parse($tarjeta->fecha_expedicion)->locale('es')->format('d-m-Y') }}
                        </td>
                        <td class="px-4 py-2 border">
                            {{ \Carbon\Carbon::parse($tarjeta->fecha_vigencia)->locale('es')->format('d-m-Y') }}
                        </td>
                        <td class="px-4 py-2 border">{{ $tarjeta->estatus }}</td>
                        <td class="px-4 py-2 border">
                            @if ($tarjeta->fotografia_frontal)
                            <img src="{{ asset('img/' . $tarjeta->fotografia_frontal) }}" alt="Fotografía Frontal"
                        ...
                        <td class="px-4 py-2 border">
                            <div class="flex items-center space-x-2">
                                <!-- Ver -->
                                <a href="tarjetas/{{ $tarjeta->id_tarjeta }}"
                                ...
                                <!-- Eliminar -->
                                <form action="tarjetas/{{ $tarjeta->id_tarjeta }}" method="POST" id="eliminacion-form"
                                    class="inline">
                                    @csrf
                                    @method('DELETE')
