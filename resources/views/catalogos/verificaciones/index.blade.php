            ...
            <div class="mb-2">
                <div class="flex justify-between">
                    <form action="{{ route('verificaciones.index') }}" method="GET"
                        ...
                        <div class="flex items-center w-full md:w-auto">
                            ...
                            <button type="submit"
                                class="flex items-center px-4 py-2 ml-1 text-white bg-blue-600 border-l-0 rounded-r-md hover:bg-blue-700 focus:outline-none" title="Realizar búsqueda">
                                Buscar
                            </button>
                        </div>
                    </form>
                ...
                <div class="flex justify-end ml-2 space-x-2">
                    ...
                    <a href="{{ route('verificaciones.create') }}"
                        class="inline-block px-4 py-3 text-white bg-blue-600 rounded hover:bg-blue-700" title="Nuevo registro de verificación">Nuevo registro</a>
                    {{-- Calendario --}}
                    <button id="btn-calendar"
                        class="inline-flex items-center px-6 py-3 text-base font-medium text-white transition duration-150 ease-in-out bg-blue-600 border border-transparent rounded-md shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500" title="Ver calendario de verificaciones">
