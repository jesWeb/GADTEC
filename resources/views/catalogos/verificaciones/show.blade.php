                    ...
                    <article class="flex flex-wrap max-w-3xl mx-auto md:flex-nowrap group">
                        ...
                        <div class="mt-6 ml-4 space-y-6">
                            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                                @if ($MostrarVer->fecha_verificacion)
                                ...
                                <div class="p-4 bg-white rounded-lg shadow-sm">
                                    ...
                                    <span
                                        class="mt-2 text-base leading-relaxed text-gray-500 ">{{ $MostrarVer->engomado }}</span>
                                </div>
                                <div class="p-4 bg-white rounded-lg shadow-sm">
                                    <h4 class="text-lg font-semibold text-gray-800">Holograma:</h4>
                                    <span
                                        class="mt-2 text-base leading-relaxed text-gray-500 ">{{ $MostrarVer->holograma }}</span>
                                </div>
                                @if ($MostrarVer->proxima_verificacion)
                                    <div class="p-4 bg-white rounded-lg shadow-sm">
                                        ...
                                        <span class="mt-2 text-base leading-relaxed text-gray-500 ">
                                            {{ date('d-m-Y', strtotime($MostrarVer->proxima_verificacion)) }}
                                        </span>
                                    </div>
                                @endif
