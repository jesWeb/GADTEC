            ...
            <div class="p-6 bg-white rounded-lg shadow-lg">
                ...
                @endif
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Kilometros empleados durante el viaje</label>
                            <input type="text" id="resultado" class="block w-full mt-1 bg-gray-100 border border-gray-300 rounded-md shadow-sm focus:border-yellow-500 focus:ring focus:ring-yellow-200" 
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="number" name="km_salida" id="km_salida" value="{{ old('km_salida', $asignacion->checkIns->first()->km_salida) }}"
                                    ...
                                    placeholder="Kilómetros de salida" disabled title="Kilómetros al momento de la salida">
                            </div>
                            <div>
                                ...
                                <select name="combustible_salida" id="combustible_salida" 
                                    ...
                                    title="Nivel de combustible en el momento de la salida">
                       ...
                       <!-- Datos de Llegada -->
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="number" name="km_llegada" id="km_llegada" value="{{ old('km_llegada', $asignacion->checkIns->first()->km_llegada) }}" 
                                    ...
                                    placeholder="Kilómetros de llegada" required title="Kilómetros al momento de la llegada" >
                            </div>
                            ...
                            <div>
                                ...
                                <select name="combustible_llegada" id="combustible_llegada" 
                                    ...
                                    <option value="1/4" {{ old('combustible_llegada', $asignacion->checkIns->first()->combustible_llegada) == '1/4' ? 'selected' : '' }}>1/4</option>
                                    <option value="1/2" {{ old('combustible_llegada', $asignacion->checkIns->first()->combustible_llegada) == '1/2' ? 'selected' : '' }}>1/2</option>
                                    <option value="3/4" {{ old('combustible_llegada', $asignacion->checkIns->first()->combustible_llegada) == '3/4' ? 'selected' : '' }}>3/4</option>
                                    <option value="reserva" {{ old('combustible_llegada', $asignacion->checkIns->first()->combustible_llegada) == 'reserva' ? 'selected' : '' }}>Reserva</option>
                                    <option value="lleno" {{ old('combustible_llegada', $asignacion->checkIns->first()->combustible_llegada) == 'lleno' ? 'selected' : '' }}>Lleno</option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="time" name="hora_llegada" id="hora_llegada" value="{{ old('hora_llegada', $asignacion->checkIns->first()->hora_llegada) }}" 
                                    class="block w-full mt-1 border border-gray-300 rounded-md shadow-sm focus:border-yellow-500 focus:ring focus:ring-yellow-200" 
                    ...
                    <div class="flex justify-end mt-6">
                        <button type="submit" titile="Guardar datos de llegada" class="inline-flex items-center px-4 py-2 text-white bg-red-600 border border-transparent rounded-md shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                            Check-Out 
                        </button>
                        <a href="{{ route('vigilante.index') }}" titile="Cancelar registro de datos" class="inline-flex items-center px-4 py-2 ml-2 text-white bg-gray-700 border border-transparent rounded-md shadow-sm hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">Cancelar</a>
                    </div>
                </form>
            </div>
        </div>
