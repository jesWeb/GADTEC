    ...
    <div class="p-6 bg-white rounded-md shadow-md">
        ...
        <div class="grid grid-cols-1 gap-4 mt-4 sm:grid-cols-2 md:grid-cols-3">
            ...
            <div class="p-4 rounded-lg shadow bg-gray-50">
                ...
                <p><strong>Fecha de Asignación:</strong> {{ $vigilante->fecha_asignacion ? date('d/m/Y', strtotime($vigilante->fecha_asignacion)) : 'N/A' }}</p>
                <p><strong>Fecha Estimada de Devolución:</strong> <span class="text-red-600">{{ $vigilante->fecha_estimada_dev ? date('d/m/Y', strtotime($vigilante->fecha_estimada_dev)) : 'N/A' }}</span></p>
