        ...
        <div class="flex items-start justify-center gap-8">
            ...
            <div class="flex flex-col w-1/2 ml-2">
                ...
                <div class="flex gap-4 p-4 ml-2 overflow-x-auto">
                    ...
                    @endphp
                    {{-- btn-preview --}}
                    <div class=" flex justify-center w-1/2 ml-4 bg-orange-300">
                      <div class="">
                          <a id="show-image" href="" class="text-gray-500 bg-blue-400" title="Ver archivo de seguro">
                            <img src="{{ url('img/logo.png') }}" class="h-20 w-20" alt="">
                            <p>ver imagenes</p>
                        </a>
                      </div>
                    </div>
