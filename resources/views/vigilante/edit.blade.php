            ...
            @endif
                @csrf
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        <div>
                            <label for="fecha_estimada_dev" class="block text-sm font-medium text-gray-700">Fecha estimada de devolución</label>
                            <input type="date" name="fecha_estimada_dev" id="fecha_estimada_dev" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" 
                    ...
                    <div class="grid grid-cols-1 gap-4 mt-6 md:grid-cols-2">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="number" name="km_salida" id="km_salida" value="{{ old('km_salida') }}" placeholder="Ingrese KM de salida" title="Ingrese el kilometraje en el que el vehículo salió" class="block w-full mt-1 border border-gray-300 rounded-md shadow-sm focus:border-yellow-500 focus:ring focus:ring-yellow-200" required>
                            </div>

                            <div>
                                <label for="combustible_salida" class="block text-sm font-medium text-gray-700">Combustible Salida</label>
                                <select name="combustible_salida" id="combustible_salida" title="Seleccione el nivel de combustible al salir" class="block w-full mt-1 border border-gray-300 rounded-md shadow-sm focus:border-yellow-500 focus:ring focus:ring-yellow-200" required>
                                    <option value="1/4" {{ old('combustible_salida') == '1/4' ? 'selected' : '' }}>1/4</option>
                                    <option value="1/2" {{ old('combustible_salida') == '1/2' ? 'selected' : '' }}>1/2</option>
                                    <option value="3/4" {{ old('combustible_salida') == '3/4' ? 'selected' : '' }}>3/4</option>
                                    <option value="reserva" {{ old('combustible_salida') == 'reserva' ? 'selected' : '' }}>Reserva</option>
                                    <option value="lleno" {{ old('combustible_salida') == 'lleno' ? 'selected' : '' }}>Lleno</option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="time" name="hora_salida" id="hora_salida" 
                                    ...
                                    placeholder="Seleccione la hora de salida" title="Seleccione la hora en la que el vehículo salió" 
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="number" name="km_llegada" id="km_llegada" value="{{ old('km_llegada') }}" placeholder="Ingrese KM de llegada" title="Ingrese el kilometraje en el que el vehículo llegó" class="block w-full mt-1 bg-gray-100 border border-gray-300 rounded-md shadow-sm focus:border-yellow-500 focus:ring focus:ring-yellow-200" disabled>
                            </div>

                            <div>
                                <label for="combustible_llegada" class="block text-sm font-medium text-gray-700">Combustible Llegada</label>
                                <select name="combustible_llegada" id="combustible_llegada" placeholder="Seleccione el nivel de combustible al llegar" title="Seleccione el nivel de combustible al llegar" class="block w-full mt-1 bg-gray-100 border border-gray-300 rounded-md shadow-sm focus:border-yellow-500 focus:ring focus:ring-yellow-200" disabled>
                            ...
                            <div>
                                ...
                                <input type="time" name="hora_llegada" id="hora_llegada" value="{{ old('hora_llegada') }}" placeholder="Seleccione la hora de llegada" title="Seleccione la hora en la que el vehículo llegó" class="block w-full mt-1 bg-gray-100 border border-gray-300 rounded-md shadow-sm focus:border-yellow-500 focus:ring focus:ring-yellow-200" disabled>
                            </div>
