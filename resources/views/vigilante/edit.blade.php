        ...
        <div class="mt-8">
            <div class="mt-4">
                <div class="p-6 bg-white rounded-lg shadow-lg">
                    ...
                    <form action="{{ route('vigilante.update', $asignacion->id_asignacion) }}" enctype="multipart/form-data"  method="POST">
                        @csrf
                        @method('PUT')
                                ...
                                <div>
                                    ...
                                    <select name="combustible_salida" id="combustible_salida"
                                        ...
                                        <option value="reserva"
                                            {{ old('combustible_salida') == 'reserva' ? 'selected' : '' }}>Reserva</option>
                                        <option value="lleno"
                                            {{ old('combustible_salida') == 'lleno' ? 'selected' : '' }}>Lleno</option>
                                    </select>
                                </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <select name="combustible_llegada" id="combustible_llegada"
                                        ...
                                        disabled>
                                        <option value="1/4"
                                            {{ old('combustible_llegada') == '1/4' ? 'selected' : '' }}>1/4</option>
                                        <option value="1/2"
                                            {{ old('combustible_llegada') == '1/2' ? 'selected' : '' }}>1/2</option>
                                        <option value="3/4"
                                            {{ old('combustible_llegada') == '3/4' ? 'selected' : '' }}>3/4</option>
                                        <option value="vacío"
                                            {{ old('combustible_llegada') == 'vacío' ? 'selected' : '' }}>Vacío</option>
                                        <option value="reserva"
                                            {{ old('combustible_llegada') == 'reserva' ? 'selected' : '' }}>Reserva
                                        </option>
                                        <option value="lleno"
                                            {{ old('combustible_llegada') == 'lleno' ? 'selected' : '' }}>Lleno</option>
                                    </select>
                                </div>
                        ...
                        <script>
                            const fileInput = document.getElementById('fotografias_salida');
