...
<div class="mt-8">
    <div class="mt-4">
        <div class="p-6 bg-white rounded-lg shadow-lg">
            <h2 class="text-lg font-semibold text-gray-700 capitalize">Alta de Servicios</h2>
            ...
            <form action="{{ url('servicios') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                    ...
                    <!-- Se colocan los datos adicionales por funcion jQuery
                    ...
                    <div>
                        ...
                        <input class="w-full mt-2 rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" 
                               type="text" name="lugar_servicio" id="lugar_servicio" accept="image/*">
...
@endsection
 ...
 <!-- Libreria requerida para el formulario dinamico, esta dentro de public -->
