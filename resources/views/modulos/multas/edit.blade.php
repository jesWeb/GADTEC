                ...
                {{ method_field('PUT') }}
                    ...
                    <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2 md:grid-cols-3">
                        <div class="mb-4">
                            ...
                            <select name="id_automovil" id="id_automovil" value="{{ old('id_automovil', $multa->id_automovil) }}" class="block w-full mt-1 border border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" title="Actualizar automóvil">
