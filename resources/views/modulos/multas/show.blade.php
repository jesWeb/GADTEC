                ...
                <div class="p-6 bg-transparent rounded-lg shadow-sm">
                        <h2 class="text-2xl font-semibold tracking-tight text-center text-green-600 f text-primary-800 md:m-5">
                            @if($multa->automovil)
                                Multa -
                                @if($multa->automovil)
                                    {{ $multa->automovil->marca }} {{ $multa->automovil->submarca }} {{ $multa->automovil->modelo }}
                                @elseif($automovilEliminado)
                                    <p class="text-sm text-red-600">Nota: Este automóvil ha sido eliminado.</p>
                                @endif
                            @else
                                
                                <p class="text-red-600">El automóvil asociado a esta multa no existe.</p>
                                <p class="text-sm text-red-600">Nota: Este automóvil ha sido eliminado.</p>
                            @endif
            ...
            <div class="grid grid-cols-1 gap-4 mb-6 sm:grid-cols-2">
                    ...
                    <div class="p-6 bg-transparent rounded-lg shadow-sm">
                        ...
                        <p class="text-lg text-gray-600">
                            ...
                            <p class="mt-4 text-lg text-gray-600">{{ $multa->observaciones }} </p>
                            @else
                            <p class="mt-4 text-sm text-gray-500">No aplica</p>
                            @endif
                        </p>
                    </div>  
                </div> 
