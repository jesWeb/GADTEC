            ...
            <div class="p-6 bg-white rounded-lg shadow-lg">
                ...
                {{ csrf_field() }}
                    ...
                    <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                        ...
                        <div>
                            <label class="block text-base font-medium text-[#07074D]" for="comprobante" title="Adjunta un archivo de imagen del comprobante de la multa">Comprobante</label>
                            <input class="w-full mt-2 rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" 
                                type="file" name="comprobante" id="comprobante" accept="image/*" title="Adjunta un archivo de imagen del comprobante de la multa">
